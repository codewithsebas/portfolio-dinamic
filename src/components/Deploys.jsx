...
const Deploys = ({ deploy }) => {
  return (
    <div className="group flex flex-col h-96 bg-zinc-800 w-full bg-zinc-800/20 border border-zinc-800 rounded-xl hover:scale-[0.98] hover:bg-zinc-800/50 duration-300 select-none">
      <img
          src={deploy.image}
          alt="Image"
      ...
      <div className="flex justify-between items-center p-2 px-3">
        <h1 className="text-lg select-none">{deploy.title}</h1>
