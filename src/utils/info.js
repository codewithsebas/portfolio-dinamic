...
const projects = [
  {
    ...
    logo: "",
    link: "/",
    title: "Software Engineer - Jafton",
    description:
      "Developed React/Next JS apps, streamlined teamwork, gamified interactions. Ensured quality, integrated backend tech for real-time updates.",
    technologie: ["Next ", "React ", "Zustand ", "AWS"],
  },
];
...
const entrepreneur = [
  {
    ...
    technologie: ["Next ", "API ", "Tailwindcss ", "Lucide "],
  },

  {
    ...
    technologie: ["Next ", "Websockets ", "Zustand ", "AWS"],
  },
];
